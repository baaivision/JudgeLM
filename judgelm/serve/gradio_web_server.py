...
headers = {"User-Agent": "JudgeLM Client"}
...
"""
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1, min_width=50):
            send_pretext_btn = gr.Button(value="SPB", visible=False)
    ...
    send_pretext_btn.click(
        add_pretext,
        [state, model_selector, question_box, answer1_box, answer2_box],
        [state, chatbot, question_box, answer1_box, answer2_box] + btn_list
    ).then(
        bot_response,
        [state, temperature, top_p, max_output_tokens],
        [state, chatbot] + btn_list,
    ...
    return state, model_selector, chatbot, textbox, send_btn, button_row, parameter_row, question_box, answer1_box, answer2_box, send_pretext_btn
...
def build_demo_v2(models):
    with gr.Blocks(
        ...
        (
            ...
            answer2_box,
            send_pretext_btn,
        ) = build_single_model_ui_v2(models)
